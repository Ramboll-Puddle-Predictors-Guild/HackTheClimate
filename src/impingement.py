...
WINDFARM_FILES = {
    "e2": _DATA_DIR / "latvia_edata.csv",
    "nordsen iii vest": _DATA_DIR / "denmark_edata.csv",
}


def calculate_impingement(
    turbine: dict, windfarm: Literal["e2", "nordsen iii vest"], slider
):
